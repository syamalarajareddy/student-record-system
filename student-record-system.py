...
def action():
    ...
    if checkvar.get()==0:
        ...
        with open("st_records.csv", 'a', newline='') as f:
            ...
            dict_writer.writerow({'UserName': user_name, 'User email address': user_email, 'User age': user_age,
                                  'User gender': gender_vari, 'User type': user_type, 'subscribed': Subscribed})
